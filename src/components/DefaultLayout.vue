            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  :class="[this.$route.name === item.name ? '' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'px-3 py-2 rounded-md text-sm font-medium']">{{ item.name }}</router-link>
                </div>
              </div>
            </div>
            <div class="hidden md:block">
                ...
                <Menu as="div" class="relative ml-3">
                  <div>
                    <MenuButton class="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img class="h-8 w-8 rounded-full" src="https://randomuser.me/api/portraits/lego/5.jpg" alt="" />
                    </MenuButton>
                  </div>
...
import { useStore } from 'vuex';
  ...
  const navigation = [
    ...
    { name: 'Profiles', to: {name: "Profiles"}},
  ]
